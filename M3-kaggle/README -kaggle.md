...
El repositorio no incluye los datos raw ni los ficheros Parquet generados, debido a su tamaño. Estos artefactos se descargan o generan durante la ejecución del notebook/pipeline.

## Estructura incluida en GitHub
...
└── M3-kaggle/
    ...
    │   └── powerbi-etl/
    │       └── m5_powerbi_modeling.ipynb
    ├── .gitignore
    └── README.md
```
# Estructura generada durante la ejecución con outputs (incluidos ficheros raw)
