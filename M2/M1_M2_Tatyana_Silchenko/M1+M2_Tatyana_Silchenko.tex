...
En este capítulo se revisan los principales enfoques utilizados en la
predicción de demanda en retail, así como los modelos más relevantes en
el contexto de series temporales jerárquicas.
...
enfoques de modelización de demanda. La presencia de miles de
...
En este contexto, aunque existen numerosos estudios que analizan
modelos basados en boosting, redes LSTM o técnicas de reconciliación
jerárquica de forma independiente, no es habitual encontrar trabajos que
integren estos enfoques dentro de un mismo marco metodológico. Este hecho
justifica la relevancia del presente trabajo.
...
Para contextualizar esta transición, es necesario
...
SARIMA extiende ARIMA incorporando términos
...
Estas limitaciones motivaron la adopción de modelos
...
Desde un punto de vista técnico, los modelos de
...
Este enfoque se basa en un esquema de aprendizaje
...
Modelos como XGBoost y LightGBM incorporan técnicas
...
Su principal limitación es que no modelan
...
Las LSTM incorporan una arquitectura basada en
...
A pesar de estas ventajas, presentan limitaciones
...
Su inclusión en este trabajo permite comparar enfoques
...
Además de su utilidad técnica, la interpretabilidad
...
Los valores SHAP permiten identificar qué variables
...
Asimismo, SHAP favorece la comunicación entre perfiles
...
En entornos retail, donde las decisiones deben
...
Las soluciones mejor posicionadas compartieron varios
...
A continuación, se presenta un resumen estructurado de las
...
comparativa para los experimentos desarrollados en este trabajo (Tabla 2.1).
...
\multicolumn{6}{c}{}\\[-4pt]
\caption{Resumen de las soluciones mejor clasificadas en la competición M5 (Accuracy Track)} \\
\end{longtable}
